...
export function MobileBlockOverlay() {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-xl font-extrabold tracking-[-0.3px] text-white">{t('mobile.title')}</h1>

      <p className="max-w-[320px] text-sm leading-relaxed text-white/70">{t('mobile.text')}</p>
      ...
      <div className="text-xs font-semibold text-white/40">
        <strong className="text-white/60">Leisure</strong>Workspace · {t('header.tagline')}
      </div>
    </div>
  )
}
